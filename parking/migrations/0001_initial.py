    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exit_time', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Horário de saída')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Atualizado em')),
                ...
                ('parking_spot', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='parking_spots', to='parking.parkingspot', verbose_name='Vaga')),
            ],
            options={
